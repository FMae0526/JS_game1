"use strict";
    ...
    [
            ...
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 13, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 22],
            [ 9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 22],
            [ 9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 22],
            [14, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 14],
    ];
        
	/* GetContext & FirstCharacterLocale */
	var gc, px, py;
	var rx1 = 15, ry1 = 5;            // Rin First Locale
    ...
    function init_param()
    {
       ...
       var last_locale = document.referrer;
        if(last_locale.substr(-12) == "stage_3.html")
        {
            px = 1;
            py = 13;
        }
        else if(last_locale.substr(-12) == "stage_4.html")
        {
            px = 1;
            py = 1;
        }
    ...
    function init() 
    {
        ...
        onkeydown = mykeydown;
        repaint();
		TimerIDRin = setInterval(RinMove, 50);	    // Rin Move
    ...
    function mykeydown(e) 
    {
        ...
        if ((map[dy0][dx0] & 0x2) == 0)             // Nothing Wall & Object --->Going 
        {
            ...
            if((dy0 == 9) && (dx0 == 18))           // Found Treasure
            {
	...
	function RinMove() 
	{
		var dx0 = rx1, dx1 = rx1, dy0 = ry1, dy1 = ry1;
    ...
    function repaint() 
    {
        ...
        document.getElementById("location").innerHTML = "stage5" + "<br>"; // Locale
		...
		gc.drawImage(imgMapchip, 0, 160, 32, 32, rx1 * 32, ry1 * 32, 32, 32);			// Rin
