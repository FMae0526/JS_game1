"use strict";
    ...
    var map = 
    [
            [14,  9,  9,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6, 14],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 15, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 15, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 15, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9, 15,  9,  9, 15, 15, 15, 15, 15, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9, 15,  9,  9,  9,  9,  9,  9, 15, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9, 15,  9,  9,  9,  9,  9,  9, 15, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9, 15,  9,  9,  9,  9,  9,  9, 15, 15,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  6,  9,  9, 15, 15, 15, 15,  6,  6, 15, 15, 15, 15,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  6],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9],
            [14,  9,  9, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18],
    ];
        
	/* GetContext & FirstCharacterLocale */
	var gc, px, py;
	var ex1 = 4, ey1 = 3;			// Enemy1 First Locale
	var ex2 = 1, ey2 = 5;			// Enemy2 First Locale
    ...
    function init_param()
    {
       ...
       var last_locale = document.referrer;
        if(last_locale.substr(-12) == "stage_2.html")
        {
            px = 1;
            py = 1;
        }
        else if(last_locale.substr(-12) == "stage_3.html")
        {
            px = 1;
            py = 13;
        }
    ...
    function mykeydown(e) 
    {
        ...
        if ((map[dy0][dx0] & 0x2) == 0)             // Nothing Wall & Object --->Going 
        {
            ...
            if(((dy0 == 0) && (dx0 == 1)) || ((dy0 == 0) && (dx0 == 2)))        // Change1
            {
                location.assign("stage_2.html");
            }
            if(((dy0 == 14) && (dx0 == 1)) || ((dy0 == 14) && (dx0 == 2)))        // Change2
            {
                location.assign("stage_3.html");
            }
            if(((dy0 == 12) && (dx0 == 19)) || ((dy0 == 13) && (dx0 == 19)))        // Change3
            {
    ...
    function repaint() 
    {
        ...
        document.getElementById("location").innerHTML = "stage1" + "<br>"; // Locale
