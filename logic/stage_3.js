"use strict";
    ...
    [
            ...
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9, 22],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  7],
            [23,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  9,  7],
	...
	var gc, px, py;
	var ex1 = 13, ey1 = 10;			// Enemy1 First Locale
	var ex2 = 10, ey2 = 7;			// Enemy2 First Locale
    ...
    function mykeydown(e) 
    {
        ...
        if ((map[dy0][dx0] & 0x2) == 0)             // Nothing Wall & Object --->Going 
        {
            ...
            if(((dy0 == 12) && (dx0 == 18)) || ((dy0 == 13) && (dx0 == 18)))	// Door Flag
            {
                if(game_item[0][1] == 0)
                {
            ...
            if(((dy0 == 12) && (dx0 == 19)) || ((dy0 == 13) && (dx0 == 19)))         // Change2
            {
    ...
    function repaint() 
    {
        ...
        document.getElementById("location").innerHTML = "stage3" + "<br>"; // Locale
